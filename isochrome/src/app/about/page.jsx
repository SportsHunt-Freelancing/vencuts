      ...
      <div className="page" ref={container}>
        <section className="about-hero">
          <div className="about-hero-bg">
            <img src="/about/hero.jpg" alt="Vencuts About Hero Image" />
          </div>
        ...
        <section className="about-copy">
          <div className="container">
            ...
            <div className="about-copy-wrapper">
              <AnimatedCopy>
                Vencuts is more than a creative agency—we are storytellers,
              ...
              <AnimatedCopy delay={0.5}>
                At Vencuts, we push boundaries, challenge conventions, and
              ...
              <div className="about-copy-img">
                <div className="about-copy-img-wrapper">
                  <ParallaxImage
                    ...
                    alt="Vencuts Creative Team at Work"
                    speed={0.2}
                  />
                </div>
              </div>
        ...
        <section className="founder-voice">
          <div className="container">
            <AnimatedCopy tag="h2">
              "Vencuts revolutionizes influencer marketing by seamlessly
